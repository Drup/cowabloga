...
(* OASIS_START *)
(* DO NOT EDIT (digest: a80c0ce351d2ff95beb6a1dbb9b0b3d4) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "lib/frontend";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "cowabloga";
                           FindlibPackage ("lambdoc", None);
                   ...
                   {
                      lib_modules = ["Cowalambdoc"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "cowabloga";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\208\nM\149\206\232\168/\183AP\142\238w\132L";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
